...
* Enhance numerals localization using différent systems (decimal, 
  vigesimal...). 
* Use characters of the language for numerals. Ex: Roman numbers 
  (Ⅰ, Ⅱ, Ⅲ, Ⅳ...), traditional chinese/japanese numbers (一, 二, 三, 
  四...)